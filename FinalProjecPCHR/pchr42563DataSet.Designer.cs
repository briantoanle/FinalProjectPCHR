...
namespace FinalProjecPCHR.pchr42563DataSetTableAdapters {
...
SELECT PATIENT_ID, ALLERGY_ID, ALLERGEN, ONSET_DATE, NOTE FROM ALLERGY_TBL WHERE (ALLERGY_ID = @ALLERGY_ID) AND (PATIENT_ID = @PATIENT_ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::FinalProjecPCHR.Properties.Settings.Default.pchr42563ConnectionString;
        }
